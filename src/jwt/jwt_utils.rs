...
pub fn jwt_utils(props: &JwtUtilsProps) -> Html {
    ...
    let recalculate_signature = Callback::from(move |_event: MouseEvent| {
    ...
    html! {
        <div class={classes!("vertical")}>
            ...
            <div class={classes!("horizontal")}>
                ...
                <button class={classes!("jwt-util-button")} onclick={recalculate_signature}>{"Recalculate signature"}</button>
