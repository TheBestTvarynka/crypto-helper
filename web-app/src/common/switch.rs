use yew::{Html, function_component, html, classes, Properties, UseStateSetter, Callback};
...
pub fn switch(props: &SwitchProps) -> Html {
    ...
    html! {
        <span class={classes!("switch_span")}>
            <input type={"checkbox"} id={props.id.clone()} class={classes!("switch_input")} onchange={onchange} checked={props.state} />
